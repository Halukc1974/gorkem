              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl>
                      <SelectTrigger data-testid="select-sheet-template">
                        <SelectValue placeholder="Şablon seçin" />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                      <SelectItem value="custom">Özel</SelectItem>
                      <SelectItem value="accounting">Muhasebe Şablonu</SelectItem>
                      <SelectItem value="project">Proje Şablonu</SelectItem>
                      <SelectItem value="personnel">Personel Şablonu</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
